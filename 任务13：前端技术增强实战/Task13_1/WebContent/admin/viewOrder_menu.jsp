...
<body>
	<form action="getOrderByID.action" method="post" name="form1"
		id="form1" onsubmit="return check1();">
		<p align="center" class="style1">
			★ <a href="getAllOrder.action"> 查看所有订单</a>
		</p>
		<p align="center" class="style1">
			★ <span class="style4">按订单ID进行查找：</span> <input name="ordersId"
				type="number" id="ordersId"> <input type="submit"
				 value="查找">
		</p>
	</form>
	<form action="getOrderByName.action" method="post" name="form2"

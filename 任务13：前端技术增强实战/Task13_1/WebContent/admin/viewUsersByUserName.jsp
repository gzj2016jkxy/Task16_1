			...
			if (user != null) {
				...
				try {
					...
					out.println("<td width='19%'><div align=center class=style13>" + user.getUsersAddress()
							+ "</div></td>");
					out.println(
							"<td width='22%'><div align=center class=style13>" + user.getUsersPhone() + "</div></td>");
					out.println(
							"<td width='12%'><div align=center class=style13>" + user.getUsersE_mail() + "</div></td>");
				} catch (Exception e) {
				}
				out.println("<td><div align=center class=style13><a href='delUser.action?usersId=" + user.getUsersId()
						+ "'>删除</a></div></td>");
				out.println("</tr>");
			}
		%>

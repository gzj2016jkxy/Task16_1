...
<body>
		...
		<tbody>
			...
			<tr>
				...
				<td bgcolor="#ffffff" colspan="7">
					<div align="right">
						<a name="top"></a><a href="register/cart.jsp"><img height="20"
			...
			<tr>
				...
				<td colspan="11"><a href="<%=path%>/getProduce.action"><img height="27"
						alt="" src="<%=path%>/tourist/cartImage.files/title_r2_c10.gif" width="77"
						border="0" name="title_r2_c10"></a><a
			...
			<tr>
				<td width="397" height="40">
					<div class="blue2" align="center">
						<div align="left">以下为目前在本网站注册销售的企业名单：</div>
						<div align="left"></div>
					</div>
				</td>
				<td width="352">
	...
	<table cellspacing="1" cellpadding="1" width="812" align="center"
		...
		<tbody>
			...
			<%
				List<Produce> list = (List<Produce>) session.getAttribute("Produce");
				if (list != null) {
					Iterator<Produce> iterator = list.iterator();
					while (iterator.hasNext()) {
						Produce produce = iterator.next();
			%>
			<tr bgcolor=#FFFFFF>
				<td colspan="2"><div align=center><%=produce.getProduceId()%></div></td>
				<td>
					<div align=center><%=produce.getProduceName()%></div>
				</td>
				<td><div align=center>
						<a
							href='getProduceDetail.action?produceId=<%=produce.getProduceId()%>'
							class="style5">点此查看</a>
					</div></td>
			</tr>
			<%

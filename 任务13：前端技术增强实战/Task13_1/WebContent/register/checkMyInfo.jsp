...
<body>
	<table cellspacing="0" cellpadding="0" width="812" align="center"
		...
		<tbody>
			<tr>
				<td><img height="1" alt="" src="cartImage.files/spacer.gif"
			...
			<tr>
				<td colspan="6" rowspan="2"><img height="79" alt=""
					src="cartImage.files/title_r1_c1.gif" width="294" border="0"
					name="title_r1_c1"></td>
				<td bgcolor="#ffffff" colspan="7">
					<div align="right">
						<a name="top"></a><a href="cart.jsp"><img height="20"
							src="cartImage.files/top_cart.gif" width="76" border="0"></a> <a
							onfocus="this.blur()" href="checkMyInfo.jsp"><img height="20"
							src="cartImage.files/top_my.gif" width="76" border="0"></a> <a
							onfocus="this.blur()" href="../tourist/help.jsp"><img
							height="20" src="cartImage.files/top_faq.gif" width="76"
							border="0"></a> <a onfocus="this.blur()"
							href="../index.jsp?exit=yes"><img height="20"
							src="cartImage.files/top_wh.gif" width="76" border="0"></a>
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
					<td><img height="27" alt=""
						src="cartImage.files/title_r2_c1.gif" width="38" border="0"
						name="title_r2_c1"></td>
					...
					<td colspan="11"><a href="getProduce.action"><img
							height="27" alt="" src="cartImage.files/title_r2_c10.gif"
						...
						href="../tourist/language.jsp"><img height="27" alt=""
							...
							height="27" alt="" src="cartImage.files/title_r2_c12.gif"
							width="72" border="0" name="title_r2_c12"></a><img height="27"
						alt="" src="cartImage.files/title_r2_c13.gif" width="482"
		...
		<tbody>
			<tr bgcolor="#00addf">
				<td width="13%" bgcolor="#00addf" height="22">
					<div class="white1" align="center">用户号</div>
				</td>
				<td width="15%" height="22">
					<div class="white1" align="center">用户名</div>
				</td>
				<td width="15%" height="22">
					<div class="white1" align="center">真实姓名</div>
				</td>
			...
			<%
				try {
					...
					if(users!=null){
						...
						out.println(" <td><div align=center>" + users.getUsersId() + "</div></td>");
						out.println("<td><div align=center>" + users.getUsersName() + "</div></td>");
	
						out.println("<td><div align=center>" + users.getUsersTrueName() + "</div></td>");
						out.println("<td><div align=center>" + users.getUsersAddress() + "</div></td>");
						out.println("<td><div align=center>" + users.getUsersPhone() + "</div></td>");
						out.println("<td><div align=center>" + users.getUsersE_mail() + "</div></td>");
						out.println("</tr>");
					}
			...
			<tr bgcolor="#ffffff">
				<td colspan="8" height="25">&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<div align="center">
						<span class="style5"><a href="<%=path%>/getOrder.action"
							class="style1 style2">点此查看您的历史订单</a></span>
					</div>

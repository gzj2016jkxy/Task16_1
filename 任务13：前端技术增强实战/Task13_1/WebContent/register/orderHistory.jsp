			...
			<tr>
				...
				<td bgcolor="#ffffff" colspan="7">
					<div align="right">
						...
						<a onfocus="this.blur()" href="index.jsp"><img height="20"
							src="register/cartImage.files/top_wh.gif" width="76" border="0"></a>
					</div>
				</td>
			</tr>
			<tr>
		...
		<tbody>
			<tr bgcolor="#00addf">
				...
				<td width="21%" height="22">
					<div class="white1" align="center">订单总价</div>
				</td>
			...
			<tr bgcolor=#FFFFFF>
				...
				<td>
					<div align=center><%=orders.getOrdersPrice()%></div>
				</td>
				<td><div align=center><%=orders.getOrdersDatetime()%></div></td>
				<td><div align=center>
						<a
							href='<%=path%>/getOrderDetail.action?ordersId=<%=orders.getOrdersId()%>'
							class="style5">点此查看</a>
					</div></td>
			</tr>
			<%

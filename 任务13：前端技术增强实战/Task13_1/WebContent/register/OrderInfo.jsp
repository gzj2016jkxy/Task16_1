			...
			<tr>
				...
				<td bgcolor="#ffffff" colspan="7">
					<div align="right">
						...
						<a onfocus="this.blur()" href="logout.action"><img
		...
		<tbody>
			<tr bgcolor="#00addf">
				...
				<td width="23%" height="22">
					<div class="white1" align="center">总价</div>
				</td>
			...
			<tr bgcolor="#FFFFFF">
				<td><div align="center"><%=orders.getOrdersId()%></div></td>   
    			<td><div align="center"><%=orders.getUsersName()%></div></td>
	 			<td><div align="center"><%=orders.getOrdersPrice()%></div></td>
	 			<td><div align="center"><%=orders.getOrdersDatetime()%></div></td>
			</tr>

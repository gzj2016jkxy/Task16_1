...
CREATE TABLE `users` (
	...
	`usersName` varchar(40) NOT NULL default '',		
	`usersPass` varchar(40) default NULL,				
	`usersPassQuestion` varchar(40) default NULL,		
	`usersPassReply` varchar(40) default NULL,			
	`usersTrueName` varchar(40) default NULL,			
	`usersAddress` varchar(100) default NULL,			
	`usersPhone` varchar(100) default NULL,				
	`usersE_mail` varchar(100) default NULL,				
	PRIMARY KEY (`usersId`)								
...
CREATE TABLE `orders` (
	...
	`ordersPrice` varchar(40) default NULL,				
	`ordersDatetime` varchar(40) default NULL,			
...
CREATE TABLE `ordersDetails` (
	...
	`goodsName` varchar(40) NOT NULL,					
	`goodsPrice` varchar(40) default NULL,				

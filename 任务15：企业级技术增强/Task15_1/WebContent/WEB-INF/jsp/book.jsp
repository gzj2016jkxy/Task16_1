...
<script type="text/javascript">
	function del(id){
		$.post("<%=path%>/gzj/delBook?id=" + id,function(data){
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<thead>
											<tr>
												...
												<th style="text-align: center;">国际标准书号</th>
												<th style="text-align: center;">图书类型</th>
												<th style="text-align: center;">书名</th>
												<th style="text-align: center;">作者</th>
												<th style="text-align: center;">译者</th>
										...
										<tbody>
											<c:forEach items="${bookInfos}" var="bookInfo"
												...
												<tr class="odd gradeX">
													<td align="center">
														<c:out value="${bookInfo.getId()}" />
													</td>
													<td align="center">
														<c:out value="${bookInfo.getIsbn()}" />
													</td>
													<td align="center">
														<c:out value="${bookInfo.getBookType().getTypeName()}" />
													</td>
													<td align="center">
														<c:out value="${bookInfo.getBookName()}" />
													</td>
													<td align="center">
														<c:out value="${bookInfo.getWriter()}" />
													</td>
													<td align="center">
														<c:out value="${bookInfo.getTranslater()}" />
													</td>
													<td align="center">
														<c:out value="${bookInfo.getPublisher()}" />
													</td>
													<td align="center">
														<c:out value="${bookInfo.getDate()}" />
													</td>
													<td align="center">
														<c:out value="${bookInfo.getPrice()}" />
													</td>													
													<td align="center">
														<a href="<%=path%>/gzj/getOneBook?id=${bookInfo.getId()}">修改</a>
														<a href="javascript:del('${bookInfo.getId()}')">删除</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
